...
Introduces a day-night cycle into DK64 globally

## Installation
1. Download the latest `day_night_cycle.nrm` from Releases.
...
The produced mod file is named `day_night_cycle.nrm`.
